...
public class DataBaseHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/"
			+ HusonMuslimActivity.PACKAGE_NAME + "/databases/";
	...
	public ArrayList<HashMap<String, String>> get_semi_chapters_fav()// get allsemichapters
	{
		ArrayList<HashMap<String, String>> contentList = new ArrayList<HashMap<String, String>>();
	...
	public boolean get_fav_count(String content_id)
	{
		...
		// Select All Query
		String selectQuery = "SELECT favourite._id FROM favourite where favourite.content_id = "+content_id;
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public ArrayList<HashMap<String, String>> delete_fav(String fav_id)// get allsemichapters
	{
		 SQLiteDatabase db = this.getReadableDatabase();
	...
	public ArrayList<HashMap<String, String>> delete_fav_by_content_id(String content_id)// get allsemichapters
	{
		 SQLiteDatabase db = this.getReadableDatabase();
